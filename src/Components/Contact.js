...
import "./Contact.css";
import pic from "../assest/vladislav-glukhotko-nwMG_761sbM-unsplash.jpg";
...
function Contacts() {
  ...
  return (
    ...
    //   <img
    //     className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-half iga"
    //     src="stack.jpeg"
    //     alt="gradient"
    //   />
          ...
          <Row>
            <Col>
              ...
              <h2 className="strong">
                <strong>
                  Get Connected <br />
                  To Receive The Best <br /> Work and Designs
                </strong>
              </h2>
              <br />
              <br />
              ...
              <h6 className="font-bold text-white email1">philsteps1@gmail.com</h6>
              <br />
              <br />
              <h6 className="font-bold call">CALL</h6>
              <h6 className="font-bold text-white call1">+233 0236384849</h6>
              <h6 className="font-bold text-white call1">+233 0236384849</h6>
            </Col>
                ...
                <form onSubmit={checkValidation}>
                  <div>
                    <ul>
                      ...
                      <br />
                      <br />
                      <button className="button"><p className="p">Send Message</p></button>
                      <p>{message}</p>
                    </ul>
                  </div>
                </form>
